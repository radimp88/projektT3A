...
namespace Projekt_T3A
{
    public partial class FormHra : Form
    {
        ...
        private void nastrojZpet_Click(object sender, EventArgs e)
        {
        ...
        private void tlacitkoHadej_Click(object sender, EventArgs e)
        {
            ...
            if (!nalezeno)
            {
                ...
                if (pocetChyb >= 10)
                {
                    ...
                    stavovyText.Text = "Prohra";
                    return;
                }
            }

            labelSlovo.Text = new string(zobrazeneSlovo);

            if (!labelSlovo.Text.Contains("_"))
            {
                MessageBox.Show("Vyhrál jsi!");
                stavovyText.Text = "Výhra";
            }
        }

        private void NovaHra()
        {
            tajneSlovo = Microsoft.VisualBasic.Interaction.InputBox(
                "Zadej tajné slovo (bez čísel):",
                "Nová hra",
                "");
        ...
        private void nastrojNovaHra_Click(object sender, EventArgs e)
        {
            NovaHra();
        }
    }
